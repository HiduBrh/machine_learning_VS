========================================================================
    BIBLIOTHÈQUE DE LIENS DYNAMIQUES : Vue d'ensemble du projet machine_learning_grp5_library
========================================================================

AppWizard a créé cette DLL machine_learning_grp5_library pour vous.

Ce fichier contient un résumé du contenu de chacun des fichiers qui constituent votre application machine_learning_grp5_library.


machine_learning_grp5_library.vcxproj
...
machine_learning_grp5_library.vcxproj.filters
...
machine_learning_grp5_library.cpp
...
StdAfx.h, StdAfx.cpp
    Ces fichiers sont utilisés pour générer un fichier d'en-tête précompilé (PCH) machine_learning_grp5_library.pch et un fichier de type précompilé nommé StdAfx.obj.
